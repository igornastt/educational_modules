...
class ModulesTestCase(APITestCase):
    ...
    def test_1_create_modules(self):
        ...
        response = self.client.post('/educational_modules/create/', data=data)

        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
        self.assertEqual(Modules.objects.all().count(), 2)

    def test_2_list_modules(self):
        """ Тестирование вывода списка модулей """

        response = self.client.get('/educational_modules/')
    ...
    def test_3_list_all_modules(self):
        ...
        response = self.client.get('/educational_modules/all/')
    ...
    def test_4_update_modules(self):
        ...
        response = self.client.put(f'/educational_modules/update/{self.data.pk}/', data=data)
    ...
    def test_5_destroy_modules(self):
        ...
        response = self.client.delete(f'/educational_modules/delete/{self.data.pk}/')
